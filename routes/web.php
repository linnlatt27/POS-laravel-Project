...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->group(function(){
        ...
        Route::get('change/role',[AdminController::class,'adminChangeRole'])->name('admin#ChangeRole');
    });
    ...
    Route::prefix('contact')->group(function() {
        Route::get('list/{contactId}',[ContactController::class,'list'])->name('contact#list');
        Route::get('delete/{contactId}',[ContactController::class,'delete'])->name('contact#delete');
    });
});
    ...
    Route::group(['prefix'=>'user','middleware'=>'user_auth'],function () {
       ...
       Route::get('contact/{contactId}',[UserController::class,'contact'])->name('user#contact');
