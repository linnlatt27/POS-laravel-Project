        ...
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <a href="{{route('user#home')}}" class="text-decoration-none text-dark">
                    <i class="fa-solid fa-arrow-left class me-1"></i>back
                </a>
                <div id="product-carousel" class="carousel slide mt-3" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-90" src="{{asset('storage/'.$pizza->image)}}" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="h-100 bg-light p-30">
                   ...
                   <div class="d-flex mb-3">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button type="button" class=" btn-primary px-3" id="addCartBtn"><i class="fa fa-shopping-cart mr-1"></i> Add To
                            Cart</button>
                    </div>
