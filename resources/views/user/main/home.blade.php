            ...
            <div class="row pb-3">
                <div class="col-12 pb-1">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{route('user#history')}}" class="ms-3">
                         ...
                         <a href="{{route('user#contact',Auth::user()->id)}}" class="ms-3">
                            <button type="button" class="btn bg-dark text-white position-relative">
                ...
                <span class="row" id="dataList">
                   ...
                   <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                     ...
                     @endforeach
                   @else
                     <p class="text-center shadow-sm fs-1 col-6 offset-3 py-5">There is no pizza here<i class="fa-solid fa-pizza-slice"></i></p>
                   @endif
                </span>
