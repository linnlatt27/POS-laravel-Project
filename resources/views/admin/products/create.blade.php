                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">
                            <h3 class="text-center title-2">Create Your Item</h3>
                        </div>
                        <hr>
                        <form action="{{route('products#create')}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                         @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="pizzaDescription" cols="30" rows="10" class="form-control @error('pizzaDescription')is-invalid @enderror" placeholder="Enter Description...">{{old('pizzaDescription')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="pizzaWaitingTime" value="{{old('pizzaWaitingTime')}}"  class="form-control @error('pizzaWaitingTime')is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="pizzaPrice" type="number"  class="form-control @error('pizzaPrice')is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter Price....">
                                @error('pizzaPrice')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
